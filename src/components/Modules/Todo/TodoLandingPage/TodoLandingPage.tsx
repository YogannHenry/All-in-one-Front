...
function TodoList() {
  ...
  return (
    <>
      <div className="flex items-center flex-col pt-40 max-md:pt-20 min-h-screen bg-base-200 ">
            ...
            <div className="card-body">
              {lists.map((list) => (
                <div
                  ...
                  key={list.id}
                >
                  <div className="md:w-1/2 collapse z-10">
                    <input
                  ...
                  <div className="flex p-2 gap-4 items-center md:w-1/2 min-md:items-center">
                    <div className="flex-grow" />
                    <NavLink
                      to={`/list/${list.id}`}
                      className="ml-2"
                    >
                      <svg
                        ...
                        strokeWidth={1.5}
                        stroke="currentColor"
                        className="w-9 h-9 stroke-[var(--color-primary-300)] "
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
